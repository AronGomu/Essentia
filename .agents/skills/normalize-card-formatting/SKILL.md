...
Do not create draft PDFs. Printable PDFs are generated by `.script/release_package.py rebuild|lock`; output sits directly beside aggregate MSE project. Temporary diagnostic renders must be deleted after validation.
